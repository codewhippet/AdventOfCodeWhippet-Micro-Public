...
void Puzzle10_A_2025()
{
	Puzzle10_A(R"(z:\AoCInput\2025\Puzzle10.txt)");
}

void Puzzle10_B_2025()
{
	Puzzle10_B(R"(z:\AoCInput\2025\Puzzle10.txt)");
}

void Puzzle10_C_2025()
{
	Puzzle10_C(R"(z:\AoCInput\2025\Puzzle10.txt)");
}
